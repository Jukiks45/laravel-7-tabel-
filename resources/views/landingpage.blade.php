...
<head>
    ...
    <link rel="stylesheet" href="{{asset('LP/dist/css/style.css')}}">
...
<body class="is-boxed has-animations">
    <div class="body-wrap">
            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <a href="#">
                                <img class="header-logo-image" src="{{asset('LP/dist/images/logo.svg')}}" alt="Logo">
                            </a>
                        </h1>
                    </div>
                </div>
        ...
        <main>
            ...
            <script src="{{asset('LP/dist/js/main.min.js')}}"></script>
</body>
