        ...
        <div class="sidebar-menu my-4">
            <div class="nav-list my-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/keranjang"><i class="fa-solid fa-basket-shopping mx-3"></i>Keranjang</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <table class="table" id="table_id">
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $keranjang)
                                    <tr>
                                        <td>{{ $no++ }}</td>
                                        <td>{{ $keranjang->stock->merk }}</td>
                                        <td>{{ $keranjang->ram }}</td>
                                        <td>{{ $keranjang->vga }}</td>
                                        <td>{{ $keranjang->processor }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="btn btn-danger delete"
                                                ...
                                                data-nama="{{ $keranjang->stock->merk }}"><i
